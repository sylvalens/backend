...
export class Migration1778548657226 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."cad_lieux_dits_geom_geom_idx"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."admin_regions_geom_geom_idx"`,
    );
    await queryRunner.query(`DROP INDEX "public"."admin_regions_geom_idx"`);
    await queryRunner.query(
      `DROP INDEX "public"."admin_regions_code_insee_idx"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."admin_departments_geom_geom_idx"`,
    );
    await queryRunner.query(`DROP INDEX "public"."admin_departments_geom_idx"`);
    await queryRunner.query(
      `DROP INDEX "public"."admin_departments_code_insee_idx"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."admin_departments_code_insee_de_la_region_idx"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "cad_lieux_dits" DROP COLUMN "created"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cad_lieux_dits" DROP COLUMN "updated"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_regions" DROP CONSTRAINT "admin_regions_pkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_regions" DROP COLUMN "ogc_fid"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_departments" DROP CONSTRAINT "admin_departments_pkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "admin_departments" DROP COLUMN "ogc_fid"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cad_communes" DROP CONSTRAINT "cad_communes_pkey"`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_092d919683d76e26a4f64886f8" ON "cad_lieux_dits" ("commune") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b921ecef4909c83a2f4090057c" ON "cad_lieux_dits" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_46d47b6894ec5c6d03d47c8d78" ON "admin_regions" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d23de2f0782a4e91dca4cfc6f0" ON "admin_departments" ("code_insee_de_la_region") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d0228929224be927efc7f789e7" ON "admin_departments" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e2c06ce379b1f6ceb382f8b2f3" ON "cad_communes" USING GiST ("geom") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e2c06ce379b1f6ceb382f8b2f3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d0228929224be927efc7f789e7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d23de2f0782a4e91dca4cfc6f0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_46d47b6894ec5c6d03d47c8d78"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b921ecef4909c83a2f4090057c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_092d919683d76e26a4f64886f8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cad_communes" DROP CONSTRAINT "PK_edfd68b78bc2f72b7b11fb1e467"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_departments" DROP CONSTRAINT "PK_bced5cd601e680cc78b42a06107"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_regions" DROP CONSTRAINT "PK_90d5668e2a1339593db18f76c95"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "cad_communes_id_idx" ON "cad_communes" ("id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "cad_communes_geom_idx" ON "cad_communes" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "cad_communes_geom_geom_idx" ON "cad_communes" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_departments_code_insee_de_la_region_idx" ON "admin_departments" ("code_insee_de_la_region") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_departments_code_insee_idx" ON "admin_departments" ("code_insee") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_departments_geom_idx" ON "admin_departments" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_departments_geom_geom_idx" ON "admin_departments" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_regions_code_insee_idx" ON "admin_regions" ("code_insee") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_regions_geom_idx" ON "admin_regions" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "admin_regions_geom_geom_idx" ON "admin_regions" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "cad_lieux_dits_commune_idx" ON "cad_lieux_dits" ("commune") `,
    );
    await queryRunner.query(
      `CREATE INDEX "cad_lieux_dits_geom_idx" ON "cad_lieux_dits" USING GiST ("geom") `,
    );
    await queryRunner.query(
      `CREATE INDEX "cad_lieux_dits_geom_geom_idx" ON "cad_lieux_dits" USING GiST ("geom") `,
    );
  }
}
